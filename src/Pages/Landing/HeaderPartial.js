								...
								<div className="m-menu__submenu m-menu__submenu--classNameic m-menu__submenu--left">
									...
									<ul className="m-menu__subnav">
										...
										<li className="m-menu__item  m-menu__item--submenu"  data-menu-submenu-toggle="hover" data-redirect="true" aria-haspopup="true">
											...
											<div className="m-menu__submenu m-menu__submenu--classNameic m-menu__submenu--right">
										...
										<ul className="m-menu__content">
											<li className="m-menu__item">
												...
												<ul className="m-menu__inner">
													<li className="m-menu__item "  data-redirect="true" aria-haspopup="true">
														<a  href="header/actions.html" className="m-menu__link ">
															<i className="m-menu__link-icon flaticon-map"></i>
															<span className="m-menu__link-text">
																Annual Reports
															</span>
														</a>
													...
													<li className="m-menu__item "  data-redirect="true" aria-haspopup="true">
														<a  href="header/actions.html" className="m-menu__link ">
															<i className="m-menu__link-icon flaticon-graphic-2"></i>
															<span className="m-menu__link-text">
																Revenue Reports
															</span>
														</a>
							...
							<li className="m-menu__item  m-menu__item--submenu m-menu__item--rel"  data-menu-submenu-toggle="click" data-redirect="true" aria-haspopup="true">
								...
								<div className="m-menu__submenu m-menu__submenu--classNameic m-menu__submenu--left">
									...
									<ul className="m-menu__subnav">
										...
										<li className="m-menu__item  m-menu__item--submenu"  data-menu-submenu-toggle="hover" data-redirect="true" aria-haspopup="true">
											...
											<div className="m-menu__submenu m-menu__submenu--classNameic m-menu__submenu--right">
												...
												<ul className="m-menu__subnav">
													...
													<li className="m-menu__item "  data-redirect="true" aria-haspopup="true">
														<a  href="header/actions.html" className="m-menu__link ">
															<i className="m-menu__link-icon flaticon-graphic"></i>
															<span className="m-menu__link-text">
																User Reports
															</span>
														</a>
										...
										<li className="m-menu__item  m-menu__item--submenu"  data-menu-submenu-toggle="hover" data-redirect="true" aria-haspopup="true">
											<a  href="#" className="m-menu__link m-menu__toggle">
												<i className="m-menu__link-icon flaticon-infinity"></i>
												<span className="m-menu__link-text">
													Cloud Manager
												</span>
												<i className="m-menu__hor-arrow la la-angle-right"></i>
											...
											<div className="m-menu__submenu m-menu__submenu--classNameic m-menu__submenu--left">
												...
												<ul className="m-menu__subnav">
													...
													<li className="m-menu__item "  data-redirect="true" aria-haspopup="true">
														<a  href="header/actions.html" className="m-menu__link ">
															<i className="m-menu__link-icon flaticon-signs-1"></i>
															<span className="m-menu__link-text">
																File Attributes
															</span>
														</a>
													...
													<li className="m-menu__item "  data-redirect="true" aria-haspopup="true">
														<a  href="header/actions.html" className="m-menu__link ">
															<i className="m-menu__link-icon flaticon-folder"></i>
															<span className="m-menu__link-text">
																Folders
															</span>
														</a>
													...
													<li className="m-menu__item "  data-redirect="true" aria-haspopup="true">
														<a  href="header/actions.html" className="m-menu__link ">
															<i className="m-menu__link-icon flaticon-cogwheel-2"></i>
															<span className="m-menu__link-text">
																System Settings
															</span>
														</a>
											...
											<div className="m-dropdown__body">
												<div className="m-dropdown__content">
													<ul className="m-nav m-nav--skin-light">
														...
														<li className="m-nav__separator m-nav__separator--fit"></li>
														<li className="m-nav__item">
															<a href="javascript:void(0);" className="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder" onClick={()=>this.props.setIsUserLoggedInEd()}>
																Logout
															</a>
														</li>
													</ul>
