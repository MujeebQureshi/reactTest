! function(t) {
    ...
    function f(t, e) {
        var n = t.offset(),
            i = g(t),
            s = n.left + y(t, "border-left-width") + i.left - (e ? e.left : 0),
            r = n.top + y(t, "border-top-width") + i.top - (e ? e.top : 0);
        return {
            left: s,
    ...
    function x(e) {
        var n, i, s = [],
            r = [];
        for ("string" == typeof e ? r = e.split(/\s*,\s*/) : "function" == typeof e ? r = [e] : t.isArray(e) && (r = e), n = 0; n < r.length; n++) "string" == typeof(i = r[n]) ? s.push("-" == i.charAt(0) ? {
            field: i.substring(1),
            order: -1
        } : {
            field: i,
    ...
    function z(t, e, n) {
        ...
        for (i = 0; i < n.length; i++)
            if (s = F(t, e, n[i])) return s;
        return 0
    }

    function F(t, e, n) {
        return n.func ? n.func(t, e) : P(t[n.field], e[n.field]) * (n.order || 1)
    }
    ...
    function L(t, e) {
        var n, i, s;
        for (n = 0; n < Gt.length && (i = Gt[n], !((s = N(i, t, e)) >= 1 && it(s))); n++);
        return i
    }
    ...
    function V(t, e) {
        var n, i;
        return U(t) || U(e) ? t / e : (n = t.asMonths(), i = e.asMonths(), Math.abs(n) >= 1 && it(n) && Math.abs(i) >= 1 && it(i) ? n / i : t.asDays() / e.asDays())
    }
    ...
    function ot(n, i, s) {
        ...
        return e.isMoment(u) || G(u) || void 0 === u ? l = e.apply(null, n) : (r = !1, o = !1, c ? _t.test(u) ? (n = [u += "-01"], r = !0, o = !0) : (a = qt.exec(u)) && (r = !a[5], o = !0) : t.isArray(u) && (o = !0), l = i || r ? e.utc.apply(e, n) : e.apply(null, n), r ? (l._ambigTime = !0, l._ambigZone = !0) : s && (o ? l._ambigZone = !0 : c && l.utcOffset(u))), l._fullCalendar = !0, l
    }
    ...
    function ct(t, e) {
        t.then = function(n) {
            return "function" == typeof n ? ie.resolve(n(e)) : t
        }
    }
    ...
    function dt(t, e) {
        return !t && !e || !(!t || !e) && (t.component === e.component && ft(t, e) && ft(e, t))
    }
    ...
    function mt(t) {
        ...
        for (e = 0; e < t.length; e++) {
            for (n = t[e], i = 0; i < s.length && Dt(n, s[i]).length; i++);
    ...
    function yt(t) {
        ...
        for (e = 0; e < t.length; e++)
            for (n = t[e], i = 0; i < n.length; i++)
                for ((s = n[i]).forwardSegs = [], r = e + 1; r < t.length; r++) Dt(s, t[r], s.forwardSegs)
    }
    ...
    function wt(t) {
        ...
        if (void 0 === t.forwardPressure) {
            for (e = 0; e < i.length; e++) wt(n = i[e]), s = Math.max(s, 1 + n.forwardPressure);
            t.forwardPressure = s
        }
    }
    ...
    function Ct(e, n) {
        ...
        function s(i) {
            ...
            return o && t.each(o.split(" "), function(n) {
                ...
                t.each(this.split(","), function(n, i) {
                    var r, d, f, g, p, v, m, y;
                    "title" == i ? (o = o.add(t("<h2>&nbsp;</h2>")), h = !1) : ((r = l[i]) ? (f = function(t) {
                        r.click && r.click.call(y[0], t)
                    }, (g = s.getCustomButtonIconClass(r)) || (g = s.getIconClass(i)) || (p = r.text)) : (d = e.getViewSpec(i)) ? (a.push(i), f = function() {
                        e.changeView(i)
                    }, (p = d.buttonTextOverride) || (g = s.getIconClass(i)) || (p = d.buttonTextDefault)) : e[i] && (f = function() {
                        e[i]()
                    }, (p = u[i]) || (g = s.getIconClass(i)) || (p = c[i])), f && (m = ["fc-" + i + "-button", s.getClass("button"), s.getClass("stateDefault")], p ? v = X(p) : g && (v = "<span class='" + g + "'></span>"), y = t('<button type="button" class="' + m.join(" ") + '">' + v + "</button>").click(function(t) {
                        y.hasClass(s.getClass("stateDisabled")) || (f(t), (y.hasClass(s.getClass("stateActive")) || y.hasClass(s.getClass("stateDisabled"))) && y.removeClass(s.getClass("stateHover")))
                    }).mousedown(function() {
                ...
                }), h && o.first().addClass(s.getClass("cornerLeft")).end().last().addClass(s.getClass("cornerRight")).end(), o.length > 1 ? (i = t("<div/>"), h && i.addClass(s.getClass("buttonGroup")), i.append(o), r.append(i)) : r.append(o)
            }), r
        }
        var r = this;
        r.setToolbarOptions = function(t) {
            ...
            n.layout ? (o ? o.empty() : o = this.el = t("<div class='fc-toolbar " + n.extraClasses + "'/>"), o.append(s("left")).append(s("right")).append(s("center")).append('<div class="fc-clear"/>')) : i()
        }, r.removeElement = i, r.updateTitle = function(t) {
            o && o.find("h2").text(t)
    ...
    function xt(t, e) {
        var n, i, s = [],
            r = e.startMs;
        for (t.sort(zt), n = 0; n < t.length; n++)(i = t[n]).startMs > r && s.push(new Re(r, i.startMs)), i.endMs > r && (r = i.endMs);
        return r < e.endMs && s.push(new Re(r, e.endMs)), s
    }
    ...
    function At(t) {
        return t.map(function(t) {
            return new ke(t.dateProfile.unzonedRange, t.def, t)
        })
    }
    ...
    t.fn.fullCalendar = function(e) {
        ...
        return this.each(function(s, r) {
            ...
            "string" == typeof e ? "getCalendar" === e ? s || (i = l) : "destroy" === e ? l && (l.destroy(), a.removeData("fullCalendar")) : l ? t.isFunction(l[e]) ? (o = l[e].apply(l, n), s || (i = o), "destroy" === e && a.removeData("fullCalendar")) : Lt.warn("'" + e + "' is an unknown FullCalendar method.") : Lt.warn("Attempting to call a FullCalendar method on an element with no calendar.") : l || (l = new we(a, e), a.data("fullCalendar", l), l.render())
        }), i
    };
    var Nt = ["header", "footer", "buttonText", "buttonIcons", "themeButtonIcons"];
    Lt.applyAll = j, Lt.debounce = rt, Lt.isInt = it, Lt.htmlEscape = X, Lt.cssToStr = J, Lt.proxy = st, Lt.capitaliseFirstLetter = et, Lt.getOuterRect = d, Lt.getClientRect = f, Lt.getContentRect = function(t, e) {
        var n = t.offset(),
            i = n.left + y(t, "border-left-width") + y(t, "padding-left") - (e ? e.left : 0),
            s = n.top + y(t, "border-top-width") + y(t, "padding-top") - (e ? e.top : 0);
        return {
            left: i,
            right: i + t.width(),
            top: s,
    ...
    }, Lt.getScrollbarWidths = g;
    var Vt = null;
    Lt.preventDefault = R, Lt.intersectRects = T, Lt.parseFieldSpecs = x, Lt.compareByFieldSpecs = z, Lt.compareByFieldSpec = F, Lt.flexibleCompare = P, Lt.computeGreatestUnit = L, Lt.divideRangeByDuration = function(t, e, n) {
        var i;
        return U(n) ? (e - t) / n : (i = n.asMonths(), Math.abs(i) >= 1 && it(i) ? e.diff(t, "months", !0) / i : e.diff(t, "days", !0) / n.asDays())
    }, Lt.divideDurationByDuration = V, Lt.multiplyDuration = function(t, n) {
        var i;
        return U(t) ? e.duration(t * n) : (i = t.asMonths(), Math.abs(i) >= 1 && it(i) ? e.duration({
            months: i * n
        }) : e.duration({
            days: t.asDays() * n
        }))
    }, Lt.durationHasTime = U;
    var Ut = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"],
        Gt = ["year", "month", "week", "day", "hour", "minute", "second", "millisecond"];
    Lt.log = function() {
        var t = window.console;
        if (t && t.log) return t.log.apply(t, arguments)
    }, Lt.warn = function() {
        var t = window.console;
        return t && t.warn ? t.warn.apply(t, arguments) : Lt.log.apply(Lt, arguments)
    };
    ...
    var _t = /^\s*\d{4}-\d\d$/,
        ...
        Yt = e.fn,
        jt = t.extend({}, Yt),
        Zt = e.momentProperties;
    Zt.push("_fullCalendar"), Zt.push("_ambigTime"), Zt.push("_ambigZone"), Lt.moment = function() {
            return ot(arguments)
        }, Lt.moment.utc = function() {
            var t = ot(arguments, !0);
            return t.hasTime() && t.utc(), t
        }, Lt.moment.parseZone = function() {
            return ot(arguments, !0, !0)
        }, Yt.week = Yt.weeks = function(t) {
        ...
        }, Yt.utcOffset = function(t) {
            return null != t && (this._ambigTime = !1, this._ambigZone = !1), jt.utcOffset.apply(this, arguments)
        }, Yt.format = function() {
            return this._fullCalendar && arguments[0] ? Qt(this, arguments[0]) : this._ambigTime ? Xt(at(this), "YYYY-MM-DD") : this._ambigZone ? Xt(at(this), "YYYY-MM-DD[T]HH:mm:ss") : this._fullCalendar ? Xt(at(this)) : jt.format.apply(this, arguments)
        }, Yt.toISOString = function() {
            return this._ambigTime ? Xt(at(this), "YYYY-MM-DD") : this._ambigZone ? Xt(at(this), "YYYY-MM-DD[T]HH:mm:ss") : this._fullCalendar ? jt.toISOString.apply(at(this), arguments) : jt.toISOString.apply(this, arguments)
        },
        function() {
            function t(t, e) {
            ...
            function e(t, e, n, i, s) {
                var r, o, a, l = t.sameUnits,
                    ...
                    y = "",
                    w = "";
                for (r = 0; r < l.length && (!l[r] || h.isSame(d, l[r])); r++) p += f[r];
                for (o = l.length - 1; o > r && (!l[o] || h.isSame(d, l[o])) && (o - 1 !== r || "." !== f[o]); o--) v = f[o] + v;
                for (a = r; a <= o; a++) m += f[a], y += g[a];
                return (m || y) && (w = s ? y + i + m : m + i + y), c(p + w + v)
            }
            ...
            function s(t) {
                for (var e, n = [], i = /\[([^\]]*)\]|\(([^\)]*)\)|(LTS|LT|(\w)\4*o?)|([^\w\[\(]+)/g; e = i.exec(t);) e[1] ? n.push.apply(n, r(e[1])) : e[2] ? n.push({
                    maybe: s(e[2])
                }) : e[3] ? n.push({
                    token: e[3]
                }) : e[5] && n.push.apply(n, r(e[5]));
                return n
            }
            ...
            function o(t) {
                var e, n, i = [];
                for (e = 0; e < t.length; e++) "string" == typeof(n = t[e]) ? i.push("[" + n + "]") : n.token ? n.token in p ? i.push(d + "[" + n.token + "]") : i.push(n.token) : n.maybe && i.push(f + o(n.maybe) + f);
                return i.join(h)
            }

            function a(t) {
                var e, n, i, s = [];
                for (e = 0; e < t.length; e++)(n = t[e]).token ? (i = v[n.token.charAt(0)], s.push(i ? i.unit : "second")) : n.maybe ? s.push.apply(s, a(n.maybe)) : s.push(null);
                return s
            }
            ...
            function u(e, n) {
                var i, s, r = [],
                    o = t(n, e).split(h);
                for (i = 0; i < o.length; i++)(s = o[i]).charAt(0) === d ? r.push(p[s.substring(1)](n)) : r.push(s);
                return r
            }
            ...
            Lt.formatDate = function(t, e) {
                return l(n(e).fakeFormatString, t)
            }, Lt.formatRange = function(t, i, s, r, o) {
                var a;
                return t = Lt.moment.parseZone(t), i = Lt.moment.parseZone(i), a = t.localeData(), s = a.longDateFormat(s) || s, e(n(s), t, i, r || " - ", o)
            }, Lt.oldMomentFormat = t, Lt.queryMostGranularFormatUnit = function(t) {
                var e, n, i, r, o = s(t);
                for (e = 0; e < o.length; e++)(n = o[e]).token && (i = v[n.token.charAt(0)]) && (!r || i.value > r.value) && (r = i);
    ...
    var Qt = Lt.formatDate,
        $t = Lt.formatRange,
        Xt = Lt.oldMomentFormat;
    Lt.Class = lt, lt.extend = function() {
        var t, e = {};
    ...
    var Kt = Lt.EmitterMixin = {
        ...
        ee = function(t) {
            ...
            e.standardPropMap = Object.create(e.standardPropMap), q(t, e.standardPropMap)
        },
        ne = lt.extend(Kt, Jt, {
            _props: null,
            _watchers: null,
            ...
            _watchDeps: function(t, e, n) {
                ...
                return t.forEach(function(t) {
                    var e = !1;
                    "?" === t.charAt(0) && (t = t.substring(1), e = !0), r("before:change:" + t, function(t) {
                        i()
    ...
    var re = se.extend({
        ...
        constructor: function(t) {
            se.call(this), this.waitsByNamespace = t || {}
        },
        ...
        canRunNext: function() {
            if (!se.prototype.canRunNext.apply(this, arguments)) return !1;
        ...
        compoundTask: function(t) {
            ...
            if (t.namespace && ("destroy" === t.type || "init" === t.type)) {
                for (e = i.length - 1; e >= 0; e--)(n = i[e]).namespace !== t.namespace || "add" !== n.type && "remove" !== n.type || i.splice(e, 1);
                "destroy" === t.type ? i.length && (n = i[i.length - 1]).namespace === t.namespace && ("init" === n.type ? (s = !1, i.pop()) : "destroy" === n.type && (s = !1)) : "init" === t.type && i.length && (n = i[i.length - 1]).namespace === t.namespace && "init" === n.type && i.pop()
            }
            return s && i.push(t), s
        }
    });
    ...
    var oe = lt.extend(Jt, {
        ...
        ae = Lt.CoordCache = lt.extend({
            ...
            queryBoundingRect: function() {
                var t;
                return this.els.length > 0 && !(t = h(this.els.eq(0))).is(document) ? f(t) : null
            },
        ...
        le = Lt.DragListener = lt.extend(Jt, {
            options: null,
            subjectEl: null,
            originX: null,
            originY: null,
            ...
            unbindHandlers: function() {
                this.stopListeningTo(ce.get()), this.stopListeningTo(t(document))
            },
    ...
    le.mixin({
        ...
        initAutoScroll: function() {
            var t = this.scrollEl;
            this.isAutoScroll = this.options.scroll && t && !t.is(window) && !t.is(document), this.isAutoScroll && this.listenTo(t, "scroll", rt(this.handleDebouncedScroll, 100))
        },
        ...
        updateAutoScroll: function(t) {
            var e, n, i, s, r = this.scrollSensitivity,
                ...
                a = 0,
                l = 0;
            o && (e = (r - (b(t) - o.top)) / r, n = (r - (o.bottom - b(t))) / r, i = (r - (D(t) - o.left)) / r, s = (r - (o.right - D(t))) / r, e >= 0 && e <= 1 ? a = e * this.scrollSpeed * -1 : n >= 0 && n <= 1 && (a = n * this.scrollSpeed), i >= 0 && i <= 1 ? l = i * this.scrollSpeed * -1 : s >= 0 && s <= 1 && (l = s * this.scrollSpeed)), this.setScrollVel(a, l)
        },
    ...
    var ue = le.extend({
        ...
        constructor: function(t, e) {
            le.call(this, e), this.component = t
        },
        handleInteractionStart: function(t) {
            ...
            this.component.hitsNeeded(), this.computeScrollBounds(), t ? (i = n = {
                left: D(t),
                top: b(t)
            }, s && (i = I(i, e = d(s))), this.origHit = this.queryHit(i.left, i.top), s && this.options.subjectCenter && (this.origHit && (e = T(this.origHit, e) || e), i = H(e)), this.coordAdjust = M(i, n)) : (this.origHit = null, this.coordAdjust = null), le.prototype.handleInteractionStart.apply(this, arguments)
        },
        handleDragStart: function(t) {
            var e;
            le.prototype.handleDragStart.apply(this, arguments), (e = this.queryHit(D(t), b(t))) && this.handleHitOver(e)
        },
        handleDrag: function(t, e, n) {
            var i;
            le.prototype.handleDrag.apply(this, arguments), dt(i = this.queryHit(D(n), b(n)), this.hit) || (this.hit && this.handleHitOut(), i && this.handleHitOver(i))
        },
        handleDragEnd: function() {
            this.handleHitDone(), le.prototype.handleDragEnd.apply(this, arguments)
        },
        ...
        handleInteractionEnd: function() {
            le.prototype.handleInteractionEnd.apply(this, arguments), this.origHit = null, this.hit = null, this.component.hitsNotNeeded()
        },
        handleScrollEnd: function() {
            le.prototype.handleScrollEnd.apply(this, arguments), this.isDragging && (this.component.releaseHits(), this.component.prepareHits())
        },
        queryHit: function(t, e) {
            return this.coordAdjust && (t += this.coordAdjust.left, e += this.coordAdjust.top), this.component.queryHit(t, e)
        }
    });
    Lt.touchMouseIgnoreWait = 500;
    var ce = lt.extend(Jt, Kt, {
        isTouching: !1,
        mouseIgnoreDepth: 0,
    ...
    ! function() {
        var t = null,
            e = 0;
        ce.get = function() {
            return t || (t = new ce).bind(), t
        }, ce.needed = function() {
            ce.get(), e++
        }, ce.unneeded = function() {
            --e || (t.unbind(), t = null)
        }
    }();
    var he = lt.extend(Jt, {
        ...
        de = ne.extend({
            ...
            constructor: function() {
                ne.call(this), this.children = [], this.nextDayThreshold = e.duration(this.opt("nextDayThreshold")), this.isRTL = this.opt("isRTL")
            },
            addChild: function(t) {
            ...
            buildGotoAnchorHtml: function(e, n, i) {
                var s, r, o, a;
                return t.isPlainObject(e) ? (s = e.date, r = e.type, o = e.forceOff) : s = e, s = Lt.moment(s), a = {
                    date: s.format("YYYY-MM-DD"),
                    type: r || "day"
                }, "string" == typeof n && (i = n, n = null), n = n ? " " + tt(n) : "", i = i || "", !o && this.opt("navLinks") ? "<a" + n + ' data-goto="' + X(JSON.stringify(a)) + '">' + i + "</a>" : "<span" + n + ">" + i + "</span>"
            },
            formatRange: function(t, e, n, i) {
                var s = t.end;
                return e && (s = s.clone().subtract(1)), $t(t.start, s, n, i, this.isRTL)
            },
            getAllDayHtml: function() {
                return this.opt("allDayHtml") || X(this.opt("allDayText"))
            },
            getDayClasses: function(t, e) {
                var n, i = this._getView(),
                    s = [];
                return i.activeUnzonedRange.containsDate(t) ? (s.push("fc-" + Ut[t.day()]), i.isDateInOtherMonth(t) && s.push("fc-other-month"), n = i.calendar.getNow(), t.isSame(n, "day") ? (s.push("fc-today"), !0 !== e && s.push(i.calendar.theme.getClass("today"))) : t < n ? s.push("fc-past") : s.push("fc-future")) : s.push("fc-disabled-day"), s
            },
            ...
            callChildren: function(t) {
                var e, n, i = Array.prototype.slice.call(arguments, 1),
                    s = this.children;
                for (e = 0; e < s.length; e++)(n = s[e])[t].apply(n, i)
            },
        ...
        fe = Lt.Grid = de.extend({
            ...
            constructor: function(t) {
                this.view = t, de.call(this), this.initFillInternals(), this.dayClickListener = this.buildDayClickListener(), this.daySelectListener = this.buildDaySelectListener()
            },
            opt: function(t) {
            ...
            getHitEl: function(t) {},
            setElement: function(t) {
                de.prototype.setElement.apply(this, arguments), this.hasDayInteractions && (S(t), this.bindDayHandler("touchstart", this.dayTouchStart), this.bindDayHandler("mousedown", this.dayMousedown)), this.bindSegHandlers()
            },
            ...
            removeElement: function() {
                de.prototype.removeElement.apply(this, arguments), this.clearDragListeners()
            },
            bindGlobalHandlers: function() {
                de.prototype.bindGlobalHandlers.apply(this, arguments), this.listenTo(t(document), {
                    dragstart: this.externalDragStart,
                    sortstart: this.externalDragStart
                })
            },
            unbindGlobalHandlers: function() {
                de.prototype.unbindGlobalHandlers.apply(this, arguments), this.stopListeningTo(t(document))
            },
            dayMousedown: function(t) {
                ce.get().shouldIgnoreMouse() || (this.dayClickListener.startInteraction(t), this.opt("selectable") && this.daySelectListener.startInteraction(t, {
                    distance: this.opt("selectMinDistance")
                }))
            },
            dayTouchStart: function(t) {
                var e, n = this.view;
                n.isSelected || n.selectedEvent || (null == (e = this.opt("selectLongPressDelay")) && (e = this.opt("longPressDelay")), this.dayClickListener.startInteraction(t), this.opt("selectable") && this.daySelectListener.startInteraction(t, {
                    delay: e
                }))
            },
            ...
            eventRangeToEventFootprints: function(t) {
                return [new Le(new Te(t.unzonedRange, t.eventDef.isAllDay()), t.eventDef, t.eventInstance)]
            },
    ...
    fe.mixin({
        ...
        buildDaySelectListener: function() {
            ...
            return new ue(this, {
                ...
                hitOver: function(n, i, s) {
                    var o, a;
                    s && (o = e.getSafeHitFootprint(s), a = e.getSafeHitFootprint(n), (t = o && a ? e.computeSelection(o, a) : null) ? e.renderSelectionFootprint(t) : !1 === t && r())
                },
                hitOut: function() {
        ...
        computeSelectionFootprint: function(t, e) {
            ...
            return n.sort(nt), new Te(new Re(n[0], n[3]), t.isAllDay)
        },
        ...
        renderEventsPayload: function(t) {
            var e, n, i, s, r, o = [],
                a = [];
            for (e in t) i = (n = t[e]).sliceRenderRanges(this.view.activeUnzonedRange), s = this.eventRangesToEventFootprints(i), r = this.eventFootprintsToSegs(s), n.getEventDef().hasBgRendering() ? o.push.apply(o, r) : a.push.apply(a, r);
        ...
        compareEventSegs: function(t, e) {
            var n = t.footprint.componentFootprint,
                ...
                r = s.unzonedRange;
            return i.startMs - r.startMs || r.endMs - r.startMs - (i.endMs - i.startMs) || s.isAllDay - n.isAllDay || z(t.footprint.eventDef, e.footprint.eventDef, this.view.eventOrderSpecs)
        }
    }), fe.mixin({
        ...
        diffDates: function(t, e) {
            return this.largeUnit ? k(t, e, this.largeUnit) : A(t, e)
        },
        ...
        handleSegMouseover: function(t, e) {
            ce.get().shouldIgnoreMouse() || this.mousedOverSeg || (this.mousedOverSeg = t, this.view.isEventDefResizable(t.footprint.eventDef) && t.el.addClass("fc-allow-mouse-resize"), this.publiclyTrigger("eventMouseover", {
                context: t.el[0],
                args: [t.footprint.getEventLegacy(), e, this.view]
            }))
        },
        ...
        handleSegTouchStart: function(t, e) {
            var n, i = this.view,
                ...
                r = i.isEventDefSelected(s),
                o = i.isEventDefDraggable(s),
                a = i.isEventDefResizable(s),
                l = !1;
            r && a && (l = this.startSegResize(t, e)), l || !o && !a || (null == (n = this.opt("eventLongPressDelay")) && (n = this.opt("longPressDelay")), (o ? this.buildSegDragListener(t) : this.buildSegSelectListener(t)).startInteraction(e, {
                delay: r ? 0 : n
            }))
        },
        buildSegSelectListener: function(t) {
            ...
            var r = this.segDragListener = new le({
        ...
        fabricateEventFootprint: function(t) {
            var e, n = this.view.calendar,
                ...
                s = new ze(new Ve(n));
            return s.dateProfile = i, e = s.buildInstance(), new Le(t, s, e)
        }
    }), fe.mixin({
        isDraggingSeg: !1,
        buildSegDragListener: function(t) {
            ...
            if (this.segDragListener) return this.segDragListener;
            var f = this.segDragListener = new ue(a, {
                scroll: this.opt("dragScroll"),
                subjectEl: c,
                subjectCenter: !0,
                interactionStart: function(i) {
                    t.component = s, e = !1, (n = new he(t.el, {
        ...
        computeEventDropMutation: function(t, e, n) {
            var i, s, r, o = t.unzonedRange.getStart(),
                ...
                u = !1,
                c = !1;
            return t.isAllDay !== e.isAllDay && (l = !0, e.isAllDay ? (c = !0, o.stripTime()) : u = !0), i = this.diffDates(a, o), s = new Ne, s.clearEnd = l, s.forceTimed = u, s.forceAllDay = c, s.setDateDelta(i), (r = new Oe).setDateMutation(s), r
        },
        ...
        buildSegResizeListener: function(t, e) {
            var n, i, s = this,
                ...
                h = t.footprint.eventDef,
                d = t.footprint.eventInstance;
            return this.segResizeListener = new ue(this, {
                scroll: this.opt("dragScroll"),
                subjectEl: c,
                interactionStart: function() {
                    n = !1
                ...
                hitOver: function(n, o, c) {
                    ...
                    g && p && (i = e ? s.computeEventStartResizeMutation(g, p, t.footprint) : s.computeEventEndResizeMutation(g, p, t.footprint)) ? (d = u.buildMutatedEventInstanceGroup(h.id, i), f = s.isEventInstanceGroupAllowed(d)) : f = !1, f ? i.isEmpty() && (i = null) : (i = null, r()), i && (a.hideEventsWithId(h.id), s.renderEventResize(s.eventRangesToEventFootprints(d.sliceRenderRanges(s.unzonedRange, l)), t))
                },
                hitOut: function() {
        ...
        computeEventStartResizeMutation: function(t, e, n) {
            ...
            return r.getStart().add(o) < r.getEnd() && ((i = new Ne).setStartDelta(o), (s = new Oe).setDateMutation(i), s)
        },
        computeEventEndResizeMutation: function(t, e, n) {
            var i, s, r = n.componentFootprint.unzonedRange,
                o = this.diffDates(e.unzonedRange.getEnd(), t.unzonedRange.getEnd());
            return r.getEnd().add(o) > r.getStart() && ((i = new Ne).setEndDelta(o), (s = new Oe).setDateMutation(i), s)
        },
        ...
        listenToExternalDrag: function(t, e, n) {
            var i, s = this,
                a = this.view,
                l = gt(t);
            (s.externalDragListener = new ue(this, {
                interactionStart: function() {
                ...
                hitOver: function(t) {
                    ...
                    o && (i = s.computeExternalDrop(o, l)) ? (e = new Ae(i.buildInstances()), n = l.eventProps ? s.isEventInstanceGroupAllowed(e) : s.isExternalInstanceGroupAllowed(e)) : n = !1, n || (i = null, r()), i && s.renderDrag(s.eventRangesToEventFootprints(e.sliceRenderRanges(s.unzonedRange, a.calendar)))
                },
                hitOut: function() {
                    i = null
                },
        ...
        computeExternalDrop: function(e, n) {
            var i, s = this.view.calendar,
                r = Lt.moment.utc(e.unzonedRange.startMs).stripZone();
            return e.isAllDay && (n.startTime ? r.time(n.startTime) : r.stripTime()), n.duration && (i = r.clone().add(n.duration)), r = s.applyTimezone(r), i && (i = s.applyTimezone(i)), ze.parse(t.extend({}, n.eventProps, {
                start: r,
                end: i
            }), new Ve(s))
        },
        ...
        renderFillSegEls: function(e, n) {
            ...
            if (n.length) {
                ...
                t(o).each(function(e, i) {
                    var o = n[e],
                        l = t(i);
                    r && (l = r.call(s, o, l)), l && (l = t(l)).is(s.fillSegTag) && (o.el = l, a.push(o))
                })
            }
            return a
        },
    ...
    var ge = Lt.DayTableMixin = {
            ...
            sliceRangeByRow: function(t) {
                var e, n, i, s, r, o = this.daysPerRow,
                    ...
                    c = [];
                for (e = 0; e < this.rowCnt; e++) i = (n = e * o) + o - 1, s = Math.max(l, n), r = Math.min(u, i), (s = Math.ceil(s)) <= (r = Math.floor(r)) && c.push({
                    row: e,
            ...
            sliceRangeByDay: function(t) {
                ...
                for (e = 0; e < this.rowCnt; e++)
                    for (i = (n = e * a) + a - 1, s = n; s <= i; s++) r = Math.max(u, s), o = Math.min(c, s), (r = Math.ceil(r)) <= (o = Math.floor(o)) && h.push({
                        row: e,
            ...
            renderHeadDateCellHtml: function(t, e, n) {
                var i = this.view,
                    ...
                    o = X(t.format(this.colHeadFormat));
                return 1 === this.rowCnt ? r = r.concat(this.getDayClasses(t, !0)) : r.push("fc-" + Ut[t.day()]), '<th class="' + r.join(" ") + '"' + (1 === (s && this.rowCnt) ? ' data-date="' + t.format("YYYY-MM-DD") + '"' : "") + (e > 1 ? ' colspan="' + e + '"' : "") + (n ? " " + n : "") + ">" + (s ? i.buildGotoAnchorHtml({
                    date: t,
        ...
        pe = Lt.DayGrid = fe.extend(ge, {
            ...
            renderDates: function(t) {
                ...
                for (this.el.html(o), this.rowEls = this.el.find(".fc-row"), this.cellEls = this.el.find(".fc-day, .fc-disabled-day"), this.rowCoordCache = new ae({
                        els: this.rowEls,
                        isVertical: !0
                    }), this.colCoordCache = new ae({
            ...
            renderNumberCellHtml: function(t) {
                ...
                return o || i.cellWeekNumbersVisible ? ((e = this.getDayClasses(t)).unshift("fc-day-top"), i.cellWeekNumbersVisible && (n = "ISO" === t._locale._fullCalendar_weekCalc ? 1 : t._locale.firstDayOfWeek()), s += '<td class="' + e.join(" ") + '"' + (r ? ' data-date="' + t.format() + '"' : "") + ">", i.cellWeekNumbersVisible && t.day() == n && (s += i.buildGotoAnchorHtml({
                    date: t,
                    type: "week"
                }, {
            ...
            getHitFootprint: function(t) {
                ...
                return new Te(new Re(e.start, e.end), !0)
            },
            getHitEl: function(t) {
    ...
    pe.mixin({
        rowStructs: null,
        unrenderEvents: function() {
            this.removeSegPopover(), fe.prototype.unrenderEvents.apply(this, arguments)
        },
        getEventSegs: function() {
            return fe.prototype.getEventSegs.call(this).concat(this.popoverSegs || [])
        },
        renderBgSegs: function(e) {
            var n = t.grep(e, function(t) {
                return t.footprint.componentFootprint.isAllDay
            });
            return fe.prototype.renderBgSegs.call(this, n)
        },
        ...
        renderSegRow: function(e, n) {
            function i(e) {
                for (; o < e;)(c = (m[s - 1] || [])[o]) ? c.attr("rowspan", parseInt(c.attr("rowspan") || 1, 10) + 1) : (c = t("<td/>"), a.append(c)), v[s][o] = c, m[s][o] = c, o++
            }
            ...
            for (s = 0; s < f; s++) {
                if (r = d[s], o = 0, a = t("<tr/>"), p.push([]), v.push([]), m.push([]), r)
                    for (l = 0; l < r.length; l++) {
                        for (i((u = r[l]).leftCol), c = t('<td class="fc-event-container"/>').append(u.el), u.leftCol != u.rightCol ? c.attr("colspan", u.rightCol - u.leftCol + 1) : m[s][o] = c; o <= u.rightCol;) v[s][o] = c, p[s][o] = u, o++;
                        a.append(c)
                    }
        ...
        buildSegLevels: function(t) {
            ...
            for (this.sortEventSegs(t), e = 0; e < t.length; e++) {
                for (n = t[e], i = 0; i < s.length && pt(n, s[i]); i++);
                n.level = i, (s[i] || (s[i] = [])).push(n)
            }
            for (i = 0; i < s.length; i++) s[i].sort(vt);
            return s
        },
        ...
        computeRowLevelLimit: function(e) {
            var n, i, s, r = this.rowEls.eq(e).height(),
                o = this.rowStructs[e].tbodyEl.children();
            for (n = 0; n < o.length; n++)
                if (i = o.eq(n).removeClass("fc-limited"), s = 0, i.find("> td > :first-child").each(function(e, n) {
                        s = Math.max(s, t(n).outerHeight())
                    }), i.position().top + s > r) return n;
            return !1
        },
        limitRow: function(e, n) {
            function i(i) {
                for (; E < i;)(u = w.getCellSegs(e, E, n)).length && (d = r[n - 1][E], y = w.renderMoreLink(e, E, u), m = t("<div/>").append(y), d.append(m), b.push(m[0])), E++
            }
            ...
            if (n && n < D.segLevels.length) {
                for (s = D.segLevels[n - 1], r = D.cellMatrix, o = D.tbodyEl.children().slice(n).addClass("fc-limited").get(), a = 0; a < s.length; a++) {
                    for (i((l = s[a]).leftCol), h = [], c = 0; E <= l.rightCol;) u = this.getCellSegs(e, E, n), h.push(u), c += u.length, E++;
                    if (c) {
                        for (f = (d = r[n - 1][l.leftCol]).attr("rowspan") || 1, g = [], p = 0; p < h.length; p++) v = t('<td class="fc-more-cell"/>').attr("rowspan", f), u = h[p], y = this.renderMoreLink(e, l.leftCol + p, [l].concat(u)), m = t("<div/>").append(y), v.append(m), g.push(v[0]), b.push(v[0]);
        ...
        showSegPopover: function(t, e, n, i) {
            ...
            s = 1 == this.rowCnt ? a.el : this.rowEls.eq(t), r = {
                ...
                hide: function() {
                    if (o.popoverSegs) {
                        var t, e, n;
                        for (n = 0; n < o.popoverSegs.length; ++n) e = (t = o.popoverSegs[n]).footprint.getEventLegacy(), o.publiclyTrigger("eventDestroy", {
                            context: e,
                            args: [e, t.el, a]
                        })
                    }
            ...
            }, this.isRTL ? r.right = l.offset().left + l.outerWidth() + 1 : r.left = l.offset().left - 1, this.segPopover = new oe(r), this.segPopover.show(), this.bindSegHandlersToEl(this.segPopover.el)
        },
        renderSegPopoverContent: function(e, n, i) {
            var s, r = this.view.calendar.theme,
                o = this.getCellDate(e, n).format(this.opt("dayPopoverFormat")),
                a = t('<div class="fc-header ' + r.getClass("popoverHeader") + '"><span class="fc-close ' + r.getIconClass("close") + '"></span><span class="fc-title">' + X(o) + '</span><div class="fc-clear"/></div><div class="fc-body ' + r.getClass("popoverContent") + '"><div class="fc-event-container"></div></div>'),
                l = a.find(".fc-event-container");
            for (i = this.renderFgSegEls(i, !0), this.popoverSegs = i, s = 0; s < i.length; s++) this.hitsNeeded(), i[s].hit = this.getCellHit(e, n), this.hitsNotNeeded(), l.append(i[s].el);
            return a
        },
        ...
        getCellSegs: function(t, e, n) {
            for (var i, s = this.rowStructs[t].segMatrix, r = n || 0, o = []; r < s.length;)(i = s[r][e]) && o.push(i), r++;
            return o
        }
    });
    var ve = Lt.TimeGrid = fe.extend(ge, {
        dayRanges: null,
        slotDuration: null,
        snapDuration: null,
        snapsPerSlot: null,
        ...
        slatCoordCache: null,
        constructor: function() {
            fe.apply(this, arguments), this.processOptions()
        },
        renderDates: function() {
            this.el.html(this.renderHtml()), this.colEls = this.el.find(".fc-day, .fc-disabled-day"), this.slatContainerEl = this.el.find(".fc-slats"), this.slatEls = this.slatContainerEl.find("tr"), this.colCoordCache = new ae({
                els: this.colEls,
                isHorizontal: !0
            }), this.slatCoordCache = new ae({
                els: this.slatEls,
                isVertical: !0
        ...
        computeLabelInterval: function(t) {
            var n, i, s;
            for (n = sn.length - 1; n >= 0; n--)
                if (i = e.duration(sn[n]), s = V(i, t), it(s) && s > 1) return i;
            return e.duration(t)
        },
        computeEventTimeFormat: function() {
        ...
        getHitFootprint: function(t) {
            ...
            return n.time(i), e = n.clone().add(this.snapDuration), new Te(new Re(n, e), !1)
        },
        getHitEl: function(t) {
        ...
        rangeUpdated: function() {
            ...
            this.updateDayTable(), this.dayRanges = this.dayDates.map(function(e) {
                return new Re(e.clone().add(t.minTime), e.clone().add(t.maxTime))
            })
        },
        ...
        renderNowIndicator: function(e) {
            var n, i = this.componentFootprintToSegs(new Te(new Re(e, e.valueOf() + 1), !1)),
    ...
    ve.mixin({
        ...
        fgSegHtml: function(t, e) {
            ...
            return '<a class="' + f.join(" ") + '"' + (u.url ? ' href="' + X(u.url) + '"' : "") + (g ? ' style="' + g + '"' : "") + '><div class="fc-content">' + (n ? '<div class="fc-time" data-start="' + X(s) + '" data-full="' + X(i) + '"><span>' + X(n) + "</span></div>" : "") + (u.title ? '<div class="fc-title">' + X(u.title) + "</div>" : "") + '</div><div class="fc-bg"/>' + (d ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
        },
        ...
        computeFgSegHorizontals: function(t) {
            var e, n, i;
            if (this.sortEventSegs(t), e = mt(t), yt(e), n = e[0]) {
                for (i = 0; i < n.length; i++) wt(n[i]);
    ...
    var me = Lt.View = de.extend({
        ...
        constructor: function(t, e) {
            this.calendar = t, this.viewSpec = e, this.type = e.type, this.options = e.options, this.name = this.type, de.call(this), this.initHiddenDays(), this.eventOrderSpecs = x(this.opt("eventOrder")), this.renderQueue = this.buildRenderQueue(), this.initAutoBatchRender(), this.initialize()
        },
        ...
        setElement: function(t) {
            de.prototype.setElement.apply(this, arguments), this.bindBaseRenderHandlers()
        },
        removeElement: function() {
            this.unsetDate(), this.unbindBaseRenderHandlers(), de.prototype.removeElement.apply(this, arguments)
        },
        setDate: function(t) {
        ...
        executeEventsRender: function(t) {
            this.renderEvents ? this.renderEvents(Et(t)) : this.renderEventsPayload(t), this.isEventsRendered = !0, this.onEventsRender()
        },
        ...
        reportEventDrop: function(t, n, i, s) {
            var r = this.calendar.eventManager.mutateEventsWithId(t.def.id, n, this.calendar),
                o = n.dateMutation;
            o && (t.dateProfile = o.buildNewDateProfile(t.dateProfile, this.calendar)), this.triggerEventDrop(t, o && o.dateDelta || e.duration(), r, i, s)
        },
        ...
        renderSelectionFootprint: function(t, e) {
            this.renderSelection ? this.renderSelection(t.toLegacy(this.calendar)) : de.prototype.renderSelectionFootprint.apply(this, arguments)
        },
    ...
    me.watch("displayingDates", ["dateProfile"], function(t) {
        this.requestDateRender(t.dateProfile)
    }, function() {
        this.requestDateUnrender()
    }), me.watch("initialEvents", ["dateProfile"], function(t) {
        return this.fetchInitialEvents(t.dateProfile)
    }), me.watch("bindingEvents", ["initialEvents"], function(t) {
        this.setEvents(t.initialEvents), this.bindEventChanges()
    }, function() {
        this.unbindEventChanges(), this.unsetEvents()
    }), me.watch("displayingEvents", ["displayingDates", "hasEvents"], function() {
        ...
        buildValidRange: function() {
            return this.getUnzonedRangeOption("validRange", this.calendar.getNow()) || new Re
        },
        buildCurrentRangeInfo: function(t, e) {
            var n, i = null,
                s = null,
                r = null;
            return this.viewSpec.duration ? (i = this.viewSpec.duration, s = this.viewSpec.durationUnit, r = this.buildRangeFromDuration(t, e, i, s)) : (n = this.opt("dayCount")) ? (s = "day", r = this.buildRangeFromDayCount(t, e, n)) : (r = this.buildCustomVisibleRange(t)) ? s = L(r.getStart(), r.getEnd()) : (s = L(i = this.getFallbackDuration()), r = this.buildRangeFromDuration(t, e, i, s)), {
                duration: i,
                unit: s,
                unzonedRange: r
            }
        ...
        adjustActiveRange: function(t, e, n) {
            var i = t.getStart(),
                s = t.getEnd();
            return this.usesMinMaxTime && (e < 0 && i.time(0).add(e), n > 864e5 && s.time(n - 864e5)), new Re(i, s)
        },
        buildRangeFromDuration: function(t, n, i, s) {
            var r, o, a, l = this.opt("dateAlignment"),
                u = t.clone();
            return i.as("days") <= 1 && this.isHiddenDay(u) && (u = this.skipHiddenDays(u, n)).startOf("day"), l || (l = (o = this.opt("dateIncrement")) && (a = e.duration(o)) < i ? O(a, o) : s), u.startOf(l), r = u.clone().add(i), new Re(u, r)
        },
        buildRangeFromDayCount: function(t, e, n) {
            var i, s = this.opt("dateAlignment"),
                r = 0,
                o = t.clone();
            s && o.startOf(s), o.startOf("day"), i = (o = this.skipHiddenDays(o, e)).clone();
            do {
        ...
        trimHiddenDays: function(t) {
            var e = t.getStart(),
                n = t.getEnd();
            return e = this.skipHiddenDays(e), n = this.skipHiddenDays(n, -1, !0), new Re(e, n)
        },
    ...
    St.prototype.proxyCall = function(t) {
    ...
    var we = Lt.Calendar = lt.extend(Kt, {
        view: null,
        viewsByType: null,
        currentDate: null,
        theme: null,
        loadingLevel: 0,
        constructor: function(t, e) {
            ce.needed(), this.el = t, this.viewsByType = {}, this.viewSpecCache = {}, this.initOptionsInternals(e), this.initMomentInternals(), this.initCurrentDate(), this.initEventManager(), Ie.call(this), this.initialize()
        },
        initialize: function() {},
        getView: function() {
            return this.view
        ...
        buildSelectFootprint: function(t, e) {
            ...
            return n = e ? this.moment(e).stripZone() : i.hasTime() ? i.clone().add(this.defaultTimedEventDuration) : i.clone().add(this.defaultAllDayEventDuration), new Te(new Re(i, n), !i.hasTime())
        },
        parseUnzonedRange: function(t) {
            var e = null,
                n = null;
            return t.start && (e = this.moment(t.start).stripZone()), t.end && (n = this.moment(t.end).stripZone()), e || n ? e && n && n.isBefore(e) ? null : new Re(e, n) : null
        },
    ...
    we.mixin({
        ...
        initOptionsInternals: function(e) {
            this.overrides = t.extend({}, e), this.dynamicOverrides = {}, this.optionsModel = new ne, this.populateOptionsHash()
        },
        option: function(t, e) {
            var n;
            if ("string" == typeof t) {
        ...
        populateOptionsHash: function() {
            var t, e, i, s;
            t = $(this.dynamicOverrides.locale, this.overrides.locale), (e = be[t]) || (t = we.defaults.locale, e = be[t] || {}), i = $(this.dynamicOverrides.isRTL, this.overrides.isRTL, e.isRTL, we.defaults.isRTL) ? we.rtlDefaults : {}, this.dirDefaults = i, this.localeDefaults = e, Ht(s = n([we.defaults, i, e, this.overrides, this.dynamicOverrides])), this.optionsModel.reset(s)
        },
        ...
        initMomentInternals: function() {
            ...
            this.defaultAllDayEventDuration = e.duration(this.opt("defaultAllDayEventDuration")), this.defaultTimedEventDuration = e.duration(this.opt("defaultTimedEventDuration")), this.optionsModel.watch("buildingMomentLocale", ["?locale", "?monthNames", "?monthNamesShort", "?dayNames", "?dayNamesShort", "?firstDay", "?weekNumberCalculation"], function(e) {
                var n, i = e.weekNumberCalculation,
                    s = e.firstDay;
                "iso" === i && (i = "ISO");
                var r = Object.create(Mt(e.locale));
                e.monthNames && (r._months = e.monthNames), e.monthNamesShort && (r._monthsShort = e.monthNamesShort), e.dayNames && (r._weekdays = e.dayNames), e.dayNamesShort && (r._weekdaysShort = e.dayNamesShort), null == s && "ISO" === i && (s = 1), null != s && ((n = Object.create(r._week)).dow = s, r._week = n), "ISO" !== i && "local" !== i && "function" != typeof i || (r._fullCalendar_weekCalc = i), t.localeData = r, t.currentDate && t.localizeMoment(t.currentDate)
            })
        },
        moment: function() {
            var t;
            return "local" === this.opt("timezone") ? (t = Lt.moment.apply(null, arguments)).hasTime() && t.local() : t = "UTC" === this.opt("timezone") ? Lt.moment.utc.apply(null, arguments) : Lt.moment.parseZone.apply(null, arguments), this.localizeMoment(t), t
        },
        msToMoment: function(t, e) {
            var n = Lt.moment.utc(t);
        ...
        footprintToDateProfile: function(t, e) {
            var n, i = Lt.moment.utc(t.unzonedRange.startMs);
            return e || (n = Lt.moment.utc(t.unzonedRange.endMs)), t.isAllDay ? (i.stripTime(), n && n.stripTime()) : (i = this.applyTimezone(i), n && (n = this.applyTimezone(n))), new Be(i, n, this)
        },
        getNow: function() {
            var t = this.opt("now");
        ...
        buildViewSpec: function(t) {
            for (var i, s, r, o, a, l = this.overrides.views || {}, u = [], c = [], h = [], d = t; d;) i = Ot[d], s = l[d], d = null, "function" == typeof i && (i = {
                class: i
            }), i && (u.unshift(i), c.unshift(i.defaults || {}), r = r || i.duration, d = d || i.type), s && (h.unshift(s), r = r || s.duration, d = d || s.type);
            return i = _(u), i.type = t, !!i.class && ((r = r || this.dynamicOverrides.duration || this.overrides.duration) && (o = e.duration(r)).valueOf() && (a = O(o, r), i.duration = o, i.durationUnit = a, 1 === o.as(a) && (i.singleUnit = a, h.unshift(l[a] || {}))), i.defaults = n(c), i.overrides = n(h), this.buildViewSpecOptions(i), this.buildViewSpecButtonText(i, t), i)
        },
        buildViewSpecOptions: function(t) {
            t.options = n([we.defaults, t.defaults, this.dirDefaults, this.localeDefaults, this.overrides, t.overrides, this.dynamicOverrides]), Ht(t.options)
        },
        ...
        initialRender: function() {
            ...
            n.addClass("fc"), n.on("click.fc", "a[data-goto]", function(n) {
                var i = t(this).data("goto"),
                    s = e.moment(i.date),
                    r = i.type,
                    o = e.view.opt("navLink" + et(r) + "Click");
                "function" == typeof o ? o(s, n) : ("string" == typeof o && (r = o), e.zoomTo(s, r))
            }), this.optionsModel.watch("settingTheme", ["?theme", "?themeSystem"], function(t) {
                var i = new(qe.getThemeClass(t.themeSystem || t.theme))(e.optionsModel),
                    s = i.getClass("widget");
                e.theme = i, s && n.addClass(s)
            }, function() {
            ...
            }), this.contentEl = t("<div class='fc-view-container'/>").prependTo(n), this.initToolbars(), this.renderHeader(), this.renderFooter(), this.renderView(this.opt("defaultView")), this.opt("handleWindowResize") && t(window).resize(this.windowResizeProxy = rt(this.windowResize.bind(this), this.opt("windowResizeDelay")))
        },
        destroy: function() {
            this.view && this.view.removeElement(), this.toolbarsManager.proxyCall("removeElement"), this.contentEl.remove(), this.el.removeClass("fc fc-ltr fc-rtl"), this.optionsModel.unwatch("settingTheme"), this.el.off(".fc"), this.windowResizeProxy && (t(window).unbind("resize", this.windowResizeProxy), this.windowResizeProxy = null), ce.unneeded()
        },
        ...
        initToolbars: function() {
            this.header = new Ct(this, this.computeHeaderOptions()), this.footer = new Ct(this, this.computeFooterOptions()), this.toolbarsManager = new St([this.header, this.footer])
        },
    ...
    we.prototype.buildCurrentBusinessFootprints = function(t) {
        return this._buildCurrentBusinessFootprints(t, this.opt("businessHours"))
    }, we.prototype._buildCurrentBusinessFootprints = function(t, e) {
    ...
    }, we.prototype.buildBusinessInstanceGroup = function(t, e, n) {
        var i, s = this.buildBusinessDefs(t, e);
        if (s.length) return i = new Ae(Pt(s, n)), i.explicitEventDef = s[0], i
    }, we.prototype.buildBusinessDefs = function(e, n) {
        var i, s = [],
            r = !1,
            o = [];
        for (!0 === n ? s = [{}] : t.isPlainObject(n) ? s = [n] : t.isArray(n) && (s = n, r = !0), i = 0; i < s.length; i++) r && !s[i].dow || o.push(this.buildBusinessDef(e, s[i]));
        return o
    }, we.prototype.buildBusinessDef = function(e, n) {
        var i = t.extend({}, De, n);
        return e && (i.start = null, i.end = null), Fe.parse(i, new Ve(this))
    }, we.prototype.isEventInstanceGroupAllowed = function(t) {
        var e, n = t.getEventDef(),
            i = this.eventRangesToEventFootprints(t.getAllEventRanges()),
            s = At(this.getPeerEventInstances(n)),
            r = this.eventRangesToEventFootprints(s),
            o = n.getConstraint(),
            a = n.getOverlap(),
            l = this.opt("eventAllow");
        for (e = 0; e < i.length; e++)
            if (!this.isFootprintAllowed(i[e].componentFootprint, r, o, a, i[e].eventInstance)) return !1;
        if (l)
            for (e = 0; e < i.length; e++)
                if (!1 === l(i[e].componentFootprint.toLegacy(this), i[e].getEventLegacy())) return !1;
        return !0
    }, we.prototype.getPeerEventInstances = function(t) {
        return this.eventManager.getEventInstancesWithoutId(t.id)
    }, we.prototype.isSelectionFootprintAllowed = function(t) {
        var e, n = At(this.eventManager.getEventInstances()),
    ...
    }, we.prototype.isFootprintAllowed = function(t, e, n, i, s) {
        var r, o;
        ...
        } else if ("function" == typeof i && !Rt(o, i, s)) return !1;
        return !(s && !Tt(o, s))
    }, we.prototype.isFootprintWithinConstraints = function(t, e) {
        var n;
        for (n = 0; n < e.length; n++)
            if (this.footprintContainsFootprint(e[n], t)) return !0;
        return !1
    }, we.prototype.constraintValToFootprints = function(t, e) {
        var n;
    ...
    }, we.prototype.eventInstancesToFootprints = function(t) {
        return kt(this.eventRangesToEventFootprints(At(t)))
    }, we.prototype.collectOverlapEventFootprints = function(t, e) {
        var n, i = [];
        for (n = 0; n < t.length; n++) this.footprintsIntersect(e, t[n].componentFootprint) && i.push(t[n]);
        return i
    }, we.prototype.parseEventDefToInstances = function(t) {
        var e = this.eventManager.currentPeriod,
            n = Me.parse(t, new Ve(this));
        return !!n && (e ? n.buildInstances(e.unzonedRange) : [])
    }, we.prototype.eventRangesToEventFootprints = function(t) {
        var e, n = [];
        for (e = 0; e < t.length; e++) n.push.apply(n, this.eventRangeToEventFootprints(t[e]));
        return n
    }, we.prototype.eventRangeToEventFootprints = function(t) {
        return [new Le(new Te(t.unzonedRange, t.eventDef.isAllDay()), t.eventDef, t.eventInstance)]
    }, we.prototype.parseFootprints = function(t) {
        var e, n;
        return t.start && ((e = this.moment(t.start)).isValid() || (e = null)), t.end && ((n = this.moment(t.end)).isValid() || (n = null)), [new Te(new Re(e, n), e && !e.hasTime() || n && !n.hasTime())]
    }, we.prototype.footprintContainsFootprint = function(t, e) {
        return t.unzonedRange.containsRange(e.unzonedRange)
    }, we.prototype.footprintsIntersect = function(t, e) {
        ...
        getEventSourceById: function(t) {
            return this.eventManager.getSourceById(Ve.normalizeId(t))
        },
        addEventSource: function(t) {
            var e = Ue.parse(t, this);
        ...
        renderEvent: function(t, e) {
            var n = this.eventManager,
                i = Me.parse(t, t.source || n.stickySource);
            i && n.addEventDef(i, e)
        },
        removeEvents: function(t) {
            var e, n, i = this.eventManager,
                s = i.getEventInstances(),
                r = {};
            if (null == t) i.removeAllEventDefs();
            else {
                for (e = It(e = s.map(function(t) {
                        return t.toLegacy()
                    }), t), n = 0; n < e.length; n++) r[this.eventManager.getEventDefByUid(e[n]._id).id] = !0;
                i.freeze();
                for (n in r) i.removeEventDefsById(n);
                i.thaw()
            }
        },
        clientEvents: function(t) {
            return It(this.eventManager.getEventInstances().map(function(t) {
                return t.toLegacy()
            }), t)
        },
        ...
        updateEvent: function(t) {
            ...
            i instanceof ze && (e = i.buildInstance(), n = Oe.createFromRawProps(e, t, null), this.eventManager.mutateEventsWithId(i.id, n))
        }
    }), we.defaults = {
        titleRangeSeparator: " – ",
    ...
    var be = Lt.locales = {};
    Lt.datepickerLocale = function(e, n, i) {
        var s = be[e] || (be[e] = {});
        s.isRTL = i.isRTL, s.weekNumberTitle = i.weekHeader, t.each(Ee, function(t, e) {
            s[t] = e(i)
    ...
    }, Lt.locale = function(e, i) {
        var s, r;
        s = be[e] || (be[e] = {}), i && (s = be[e] = n([s, i])), r = Mt(e), t.each(Se, function(t, e) {
            null == s[t] && (s[t] = e(r, s))
    ...
    Lt.locale("en", we.englishDefaults);
    var Re = Lt.UnzonedRange = lt.extend({
            startMs: null,
            endMs: null,
            isStart: !0,
            isEnd: !0,
            ...
            intersect: function(t) {
                var e = this.startMs,
                    n = this.endMs,
                    i = null;
                return null !== t.startMs && (e = null === e ? t.startMs : Math.max(e, t.startMs)), null !== t.endMs && (n = null === n ? t.endMs : Math.min(n, t.endMs)), (null === e || null === n || e < n) && ((i = new Re(e, n)).isStart = this.isStart && e === this.startMs, i.isEnd = this.isEnd && n === this.endMs), i
            },
            ...
            clone: function() {
                var t = new Re(this.startMs, this.endMs);
                return t.isStart = this.isStart, t.isEnd = this.isEnd, t
            },
            getStart: function() {
                if (null !== this.startMs) return Lt.moment.utc(this.startMs).stripZone()
            },
            getEnd: function() {
                if (null !== this.endMs) return Lt.moment.utc(this.endMs).stripZone()
            }
        }),
        Te = Lt.ComponentFootprint = lt.extend({
            unzonedRange: null,
            isAllDay: !1,
            constructor: function(t, e) {
        ...
        Ie = lt.extend(Kt, Jt, {
            ...
            otherSources: null,
            constructor: function(t) {
                this.calendar = t, this.stickySource = new Ge(t), this.otherSources = []
            },
            requestEvents: function(t, e, n, i) {
                return !i && this.currentPeriod && this.currentPeriod.isWithinRange(t, e) && n === this.currentPeriod.timezone || this.setPeriod(new He(t, e, n)), this.currentPeriod.whenReleased()
            },
            ...
            querySources: function(e) {
                ...
                for (n = 0; n < s.length; n++)
                    if ((i = s[n]) === e) return [i];
                return (i = this.getSourceById(Ve.normalizeId(e))) ? [i] : (e = Ue.parse(e, this.calendar)) ? t.grep(s, function(t) {
                    return Ft(e, t)
                }) : void 0
            },
            ...
            buildMutatedEventInstanceGroup: function(t, e) {
                var n, i, s = this.getEventDefsById(t),
                    r = [];
                for (n = 0; n < s.length; n++)(i = s[n].clone()) instanceof ze && (e.mutateSingle(i), r.push.apply(r, i.buildInstances()));
                return new Ae(r)
            },
            freeze: function() {
    ...
    var He = lt.extend(Kt, {
            ...
            constructor: function(t, e, n) {
                this.start = t, this.end = e, this.timezone = n, this.unzonedRange = new Re(t.clone().stripZone(), e.clone().stripZone()), this.requestsByUid = {}, this.eventDefsByUid = {}, this.eventDefsById = {}, this.eventInstanceGroupsById = {}
            },
            ...
            addEventInstance: function(t, e) {
                ...
                (n[e] || (n[e] = new Ae)).eventInstances.push(t), this.tryRelease()
            },
            ...
            whenReleased: function() {
                var t = this;
                return this.releaseCnt ? ie.resolve(this.eventInstanceGroupsById) : ie.construct(function(e) {
                    t.one("release", e)
                })
            },
            freeze: function() {
        ...
        Me = {
            parse: function(t, n) {
                return W(t.start) || e.isDuration(t.start) || W(t.end) || e.isDuration(t.end) ? Fe.parse(t, n) : ze.parse(t, n)
            }
        },
        xe = Lt.EventDef = lt.extend(te, {
            source: null,
            id: null,
            rawId: null,
            uid: null,
            ...
            clone: function() {
                ...
                return e.id = this.id, e.rawId = this.rawId, e.uid = this.uid, xe.copyVerbatimStandardProps(this, e), e.className = this.className, e.miscProps = t.extend({}, this.miscProps), e
            },
            ...
            toLegacy: function() {
                ...
                return e._id = this.uid, e.source = this.source, e.className = this.className, e.allDay = this.isAllDay(), null != this.rawId && (e.id = this.rawId), xe.copyVerbatimStandardProps(this, e), e
            },
            applyManualRawProps: function(e) {
                return null != e.id ? this.id = xe.normalizeId(this.rawId = e.id) : this.id = xe.generateId(), null != e._id ? this.uid = String(e._id) : this.uid = xe.generateId(), t.isArray(e.className) && (this.className = e.className), "string" == typeof e.className && (this.className = e.className.split(/\s+/)), !0
            },
            applyOtherRawProps: function(t) {
                this.miscProps = t
            }
        });
    xe.allowRawProps = ee, xe.copyVerbatimStandardProps = function(t, e) {
        var n, i = this.prototype.standardPropMap;
        for (n in i) null != t[n] && !0 === i[n] && (e[n] = t[n])
    }, xe.uuid = 0, xe.normalizeId = function(t) {
        return String(t)
    }, xe.generateId = function() {
        return "_fc" + xe.uuid++
    }, xe.allowRawProps({
        _id: !1,
        id: !1,
    ...
    var ze = xe.extend({
        ...
        buildInstance: function() {
            return new Pe(this, this.dateProfile)
        },
        isAllDay: function() {
            return this.dateProfile.isAllDay()
        },
        clone: function() {
            var t = xe.prototype.clone.call(this);
            return t.dateProfile = this.dateProfile, t
        },
        rezone: function() {
            var t = this.source.calendar,
                e = this.dateProfile;
            this.dateProfile = new Be(t.moment(e.start), e.end ? t.moment(e.end) : null, t)
        },
        applyManualRawProps: function(t) {
            var e = xe.prototype.applyManualRawProps.apply(this, arguments),
                n = Be.parse(t, this.source);
    ...
    var Fe = xe.extend({
        ...
        buildInstances: function(t) {
            for (var e, n, i, s = this.source.calendar, r = t.getStart(), o = t.getEnd(), a = []; r.isBefore(o);) this.dowHash && !this.dowHash[r.day()] || (n = (e = s.applyTimezone(r)).clone(), i = null, this.startTime ? n.time(this.startTime) : n.stripTime(), this.endTime && (i = e.clone().time(this.endTime)), a.push(new Pe(this, new Be(n, i, s)))), r.add(1, "days");
            return a
        },
        setDow: function(t) {
        ...
        clone: function() {
            var n = xe.prototype.clone.call(this);
        ...
        applyRawProps: function(t) {
            var n = xe.prototype.applyRawProps.apply(this, arguments);
        ...
        Ae = lt.extend({
            ...
            sliceNormalRenderRanges: function(t) {
                var e, n, i, s = this.eventInstances,
                    r = [];
                for (e = 0; e < s.length; e++)(i = (n = s[e]).dateProfile.unzonedRange.intersect(t)) && r.push(new ke(i, n.def, n));
                return r
            },
            sliceInverseRenderRanges: function(t) {
                var e = Bt(this.eventInstances),
                    n = this.getEventDef();
                return (e = xt(e, t)).map(function(t) {
                    return new ke(t, n)
                })
            },
            isInverse: function() {
    ...
    Be.parse = function(t, e) {
        ...
        return !!r.isValid() && (!o || o.isValid() && o.isAfter(r) || (o = null), null == a && null == (a = e.allDayDefault) && (a = s.opt("allDayDefault")), !0 === a ? (r.stripTime(), o && o.stripTime()) : !1 === a && (r.hasTime() || r.time(0), o && !o.hasTime() && o.time(0)), !o && l && (o = s.getDefaultEventEnd(!r.hasTime(), r)), new Be(r, o, s))
    };
    var ke = lt.extend({
            unzonedRange: null,
            eventDef: null,
        ...
        Le = Lt.EventFootprint = lt.extend({
        ...
        Oe = Lt.EventDefMutation = lt.extend({
            dateMutation: null,
            rawProps: null,
    ...
    Oe.createFromRawProps = function(t, e, n) {
        var i, s, r, o, a = t.def,
            l = {};
        for (i in e) "object" != typeof e[i] && "start" !== i && "end" !== i && "allDay" !== i && "source" !== i && "_id" !== i && (l[i] = e[i]);
        return (s = Be.parse(e, a.source)) && (r = Ne.createFromDiff(t.dateProfile, s, n)), o = new Oe, o.rawProps = l, r && (o.dateMutation = r), o
    };
    var Ne = lt.extend({
        clearEnd: !1,
        forceTimed: !1,
    ...
    Ne.createFromDiff = function(t, e, n) {
        function i(t, i) {
            return n ? k(t, i, n) : e.isAllDay() ? B(t, i) : A(t, i)
        }
        var s, r, o, a = t.end && !e.end,
            l = t.isAllDay() && !e.isAllDay(),
            u = !t.isAllDay() && e.isAllDay();
        return s = i(e.start, t.start), e.end && (r = i(e.unzonedRange.getEnd(), t.unzonedRange.getEnd()).subtract(s)), o = new Ne, o.clearEnd = a, o.forceTimed = l, o.forceAllDay = u, o.setDateDelta(s), o.setEndDelta(r), o
    };
    var Ve = lt.extend(te, {
        calendar: null,
        id: null,
        ...
        constructor: function(t) {
            this.calendar = t, this.className = [], this.uid = String(Ve.uuid++)
        },
        ...
        parseEventDefs: function(t) {
            var e, n, i = [];
            for (e = 0; e < t.length; e++)(n = Me.parse(t[e], this)) && i.push(n);
            return i
        },
        applyManualRawProps: function(e) {
            return null != e.id && (this.id = Ve.normalizeId(e.id)), t.isArray(e.className) ? this.className = e.className : "string" == typeof e.className && (this.className = e.className.split(/\s+/)), !0
        }
    });
    Ve.allowRawProps = ee, Ve.uuid = 0, Ve.normalizeId = function(t) {
    ...
    Lt.EventSourceParser = Ue;
    var Ge = Ve.extend({
        rawEventDefs: null,
        eventDefs: null,
        currentTimezone: null,
        constructor: function(t) {
            Ve.apply(this, arguments), this.eventDefs = []
        },
        ...
        fetch: function(t, e, n) {
            ...
            if (null !== this.currentTimezone && this.currentTimezone !== n)
                for (i = 0; i < s.length; i++) s[i] instanceof ze && s[i].rezone();
            return this.currentTimezone = n, ie.resolve(s)
        },
        addEventDef: function(t) {
        ...
        applyManualRawProps: function(t) {
            var e = Ve.prototype.applyManualRawProps.apply(this, arguments);
            return this.setRawEventDefs(t.events), e
        }
    });
    Ge.allowRawProps({
        events: !1
    }), Ge.parse = function(e, n) {
        var i;
        return t.isArray(e.events) ? i = e : t.isArray(e) && (i = {
            events: e
        }), !!i && Ve.parse.call(this, i, n)
    }, Ue.registerClass(Ge), Lt.ArrayEventSource = Ge;
    var We = Ve.extend({
        func: null,
        fetch: function(t, e, n) {
            var i = this;
            return this.calendar.pushLoading(), ie.construct(function(s) {
    ...
    We.allowRawProps({
        events: !1
    }), We.parse = function(e, n) {
        var i;
        return t.isFunction(e.events) ? i = e : t.isFunction(e) && (i = {
            events: e
        }), !!i && Ve.parse.call(this, i, n)
    }, Ue.registerClass(We), Lt.FuncEventSource = We;
    var _e = Ve.extend({
        startParam: null,
        endParam: null,
        timezoneParam: null,
        ...
        fetch: function(e, n, i) {
            ...
            return this.calendar.pushLoading(), ie.construct(function(e, n) {
                t.ajax(t.extend({}, _e.AJAX_DEFAULTS, r, {
                    data: l,
                    success: function(i) {
                        var r;
                        s.calendar.popLoading(), i ? (r = j(o, this, arguments), t.isArray(r) && (i = r), e(s.parseEventDefs(i))) : n()
                    },
                    error: function() {
                        s.calendar.popLoading(), j(a, this, arguments), n()
                    }
                }))
            })
        },
        buildRequestParams: function(e, n, i) {
            var s, r, o, a, l = this.calendar,
                u = this.ajaxSettings,
                c = {};
            return null == (s = this.startParam) && (s = l.opt("startParam")), null == (r = this.endParam) && (r = l.opt("endParam")), null == (o = this.timezoneParam) && (o = l.opt("timezoneParam")), a = t.isFunction(u.data) ? u.data() : u.data || {}, t.extend(c, a), c[s] = e.format(), c[r] = n.format(), i && "local" !== i && (c[o] = i), c
        },
        getPrimitive: function() {
            return this.ajaxSettings.url
        },
        applyOtherRawProps: function(t) {
            Ve.prototype.applyOtherRawProps.apply(this, arguments), this.ajaxSettings = t
        }
    });
    _e.AJAX_DEFAULTS = {
        dataType: "json",
        ...
        return "string" == typeof t.url ? n = t : "string" == typeof t && (n = {
            url: t
        }), !!n && Ve.parse.call(this, n, e)
    }, Ue.registerClass(_e), Lt.JsonFeedEventSource = _e;
    var qe = Lt.ThemeRegistry = {
            themeClassHash: {},
            register: function(t, e) {
                this.themeClassHash[t] = e
            },
            getThemeClass: function(t) {
                return t ? !0 === t ? Ze : this.themeClassHash[t] : je
            }
        },
        Ye = Lt.Theme = lt.extend({
            classes: {},
            iconClasses: {},
            baseIconClass: "",
    ...
    qe.register("bootstrap3", Qe);
    var $e = Lt.BasicView = me.extend({
            scroller: null,
            dayGridClass: pe,
            dayGrid: null,
            dayNumbersVisible: !1,
            ...
            headRowEl: null,
            initialize: function() {
                this.dayGrid = this.instantiateDayGrid(), this.addChild(this.dayGrid), this.scroller = new ye({
                    overflowX: "hidden",
                    overflowY: "auto"
                })
            },
            instantiateDayGrid: function() {
                return new(this.dayGridClass.extend(Xe))(this)
            },
            buildRenderRange: function(t, e) {
                var n = me.prototype.buildRenderRange.apply(this, arguments),
                    i = this.calendar.msToUtcMoment(n.startMs, this.isRangeAllDay),
                    s = this.calendar.msToUtcMoment(n.endMs, this.isRangeAllDay);
                return /^(year|month)$/.test(e) && (i.startOf("week"), s.weekday() && s.add(1, "week").startOf("week")), this.trimHiddenDays(new Re(i, s))
            },
            renderDates: function() {
            ...
            setHeight: function(t, e) {
                ...
                this.scroller.clear(), s(this.headRowEl), this.dayGrid.removeSegPopover(), o && "number" == typeof o && this.dayGrid.limitRows(o), n = this.computeScrollerHeight(t), this.setGridHeight(n, e), o && "number" != typeof o && this.dayGrid.limitRows(o), e || (this.scroller.setHeight(n), ((r = this.scroller.getScrollbarWidths()).left || r.right) && (i(this.headRowEl, r), n = this.computeScrollerHeight(t), this.scroller.setHeight(n)), this.scroller.lockOverflow(r))
            },
        ...
        Xe = {
            renderHeadIntroHtml: function() {
                var t = this.view;
                return t.colWeekNumbersVisible ? '<th class="fc-week-number ' + t.calendar.theme.getClass("widgetHeader") + '" ' + t.weekNumberStyleAttr() + "><span>" + X(this.opt("weekNumberTitle")) + "</span></th>" : ""
            },
            renderNumberIntroHtml: function(t) {
                var e = this.view,
        ...
        Ke = Lt.MonthView = $e.extend({
            buildRenderRange: function() {
                var t, e = $e.prototype.buildRenderRange.apply(this, arguments),
                    n = this.calendar.msToUtcMoment(e.startMs, this.isRangeAllDay),
                    i = this.calendar.msToUtcMoment(e.endMs, this.isRangeAllDay);
                return this.isFixedWeeks() && (t = Math.ceil(i.diff(n, "weeks", !0)), i.add(6 - t, "weeks")), new Re(n, i)
            },
            setGridHeight: function(t, e) {
    ...
    var Je = Lt.AgendaView = me.extend({
            scroller: null,
            timeGridClass: ve,
            timeGrid: null,
            dayGridClass: pe,
            ...
            usesMinMaxTime: !0,
            initialize: function() {
                this.timeGrid = this.instantiateTimeGrid(), this.addChild(this.timeGrid), this.opt("allDaySlot") && (this.dayGrid = this.instantiateDayGrid(), this.addChild(this.dayGrid)), this.scroller = new ye({
                    overflowX: "hidden",
                    overflowY: "auto"
                })
            },
            instantiateTimeGrid: function() {
                return new(this.timeGridClass.extend(tn))(this)
            },
            instantiateDayGrid: function() {
            ...
            updateSize: function(t) {
                this.timeGrid.updateSize(t), me.prototype.updateSize.call(this, t)
            },
            updateWidth: function() {
            ...
            setHeight: function(t, e) {
                var n, r, o;
                this.bottomRuleEl.hide(), this.scroller.clear(), s(this.noScrollRowEls), this.dayGrid && (this.dayGrid.removeSegPopover(), (n = this.opt("eventLimit")) && "number" != typeof n && (n = nn), n && this.dayGrid.limitRows(n)), e || (r = this.computeScrollerHeight(t), this.scroller.setHeight(r), ((o = this.scroller.getScrollbarWidths()).left || o.right) && (i(this.noScrollRowEls, o), r = this.computeScrollerHeight(t), this.scroller.setHeight(r)), this.scroller.lockOverflow(o), this.timeGrid.getTotalSlatHeight() < r && this.bottomRuleEl.show())
            },
            computeScrollerHeight: function(t) {
                return t - c(this.el, this.scroller.el)
            },
            ...
            renderEventsPayload: function(t) {
                var e, n, i = {},
                    s = {};
                for (e in t)(n = t[e]).getEventDef().isAllDay() ? i[e] = n : s[e] = n;
        ...
        tn = {
            renderHeadIntroHtml: function() {
                ...
                }, X(t)) + "</th>") : '<th class="fc-axis ' + e.calendar.theme.getClass("widgetHeader") + '" ' + e.axisStyleAttr() + "></th>"
            },
            renderBgIntroHtml: function() {
                var t = this.view;
    ...
    var rn = me.extend({
            ...
            scroller: null,
            initialize: function() {
                this.grid = new on(this), this.addChild(this.grid), this.scroller = new ye({
                    overflowX: "hidden",
                    overflowY: "auto"
                })
            },
        ...
        on = fe.extend({
            ...
            rangeUpdated: function() {
                for (var t = this.view.calendar, e = t.msToUtcMoment(this.unzonedRange.startMs, !0), n = t.msToUtcMoment(this.unzonedRange.endMs, !0), i = [], s = []; e < n;) i.push(e.clone()), s.push(new Re(e, e.clone().add(1, "day"))), e.add(1, "day");
            ...
            handleSegClick: function(e, n) {
                var i;
                fe.prototype.handleSegClick.apply(this, arguments), t(n.target).closest("a[href]").length || (i = e.footprint.eventDef.url) && !n.isDefaultPrevented() && (window.location.href = i)
            },
            renderFgSegs: function(t) {
                return (t = this.renderFgSegEls(t)).length ? this.renderSegList(t) : this.renderEmptyMessage(), t
            },
            renderEmptyMessage: function() {
                this.el.html('<div class="fc-list-empty-wrap2"><div class="fc-list-empty-wrap1"><div class="fc-list-empty">' + X(this.opt("noEventsMessage")) + "</div></div></div>")
            },
            ...
            dayHeaderHtml: function(t) {
                ...
                }, X(t.format(n))) : "") + (i ? e.buildGotoAnchorHtml(t, {
...
function(t) {
        ...
        u = r.extend({
            ...
            fetch: function(e, n, i) {
                var r = this,
                    ...
                    c = this.ajaxSettings,
                    h = c.success;
                return u ? s.construct(function(e, n) {
                    t.ajax(t.extend({}, o.AJAX_DEFAULTS, c, {
                        url: a,
                        data: u,
                        success: function(i) {
                            var s, o;
                            i.error ? (r.reportError("Google Calendar API: " + i.error.message, i.error.errors), n()) : i.items && (s = r.gcalItemsToRawEventDefs(i.items, u.timeZone), o = l(h, this, [s].concat(Array.prototype.slice.call(arguments, 1))), t.isArray(o) && (s = o), e(r.parseEventDefs(s)))
                        }
                    }))
                }) : s.reject()
            },
            ...
            buildRequestParams: function(e, n, i) {
                var s, r = this.googleCalendarApiKey || this.calendar.opt("googleCalendarApiKey");
                return r ? (e.hasZone() || (e = e.clone().utc().add(-1, "day")), n.hasZone() || (n = n.clone().utc().add(1, "day")), s = t.extend(this.ajaxSettings.data || {}, {
                    key: r,
                    timeMin: e.format(),
                    timeMax: n.format(),
                    singleEvents: !0,
                    maxResults: 9999
                }), i && "local" !== i && (s.timeZone = i.replace(" ", "_")), s) : (this.reportError("Specify a googleCalendarApiKey. See http://fullcalendar.io/docs/google_calendar/"), null)
            },
            reportError: function(t, e) {
                var n = this.calendar,
                    s = n.opt("googleCalendarError"),
                    r = e || [{
                        message: t
                    }];
                this.googleCalendarError && this.googleCalendarError.apply(n, r), s && s.apply(n, r), i.warn.apply(null, [t].concat(e || []))
            },
            getPrimitive: function() {
                return this.googleCalendarId
            },
            applyManualRawProps: function(t) {
                var n = r.prototype.applyManualRawProps.apply(this, arguments),
    ...
    u.API_BASE = "https://www.googleapis.com/calendar/v3/calendars", u.allowRawProps({
        url: !1,
        googleCalendarId: !1,
